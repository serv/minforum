...
describe User do
  ...
  describe "when name format is invalid" do
    it "should be invalid" do
      names = %w[wo@rd wo!rd wo#rd wo$rd wo%rd wo^rd wo&rd wo*rd wo()rd 
        wo.rd wo<rd wo>rd wo/rd wo?rd]
  ...
  describe "when name format is valid" do
    it "should be valid" do
      names = %w[word Word WORd word432 24word wo4rd ]
      names.each do |valid_names|
        @user.name = valid_names
